  ...
  return (
    <Link href={href} className="block">
      <article className="group relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-16 md:mb-24">
        <div className="overflow-hidden rounded-2xl relative shadow-2xl bg-black/20">
          <img
            src={item.image}
            alt={item.title}
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="group/btn inline-flex items-center gap-3 bg-white/5 border border-white/10 group-hover:bg-brand-red group-hover:border-brand-red px-8 py-4 text-white font-bold text-sm uppercase tracking-[0.2em] transition-all duration-300 backdrop-blur-sm self-start">
            Read Full Story

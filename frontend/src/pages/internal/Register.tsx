        ...
        <section className="relative md:w-1/2 flex flex-col justify-center items-center p-10 text-white overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-blue-100 text-lg max-w-sm leading-relaxed">
              Welcome to the <span className="font-semibold text-white">SQS Portal</span>. Complete your registration to access the system.
            </p>
          </div>
        </section>
          ...
          <Card className="border-0 shadow-none bg-transparent">
            ...
            <div className="p-4 my-2 bg-green-50/20 border border-green-100/40 rounded-xl text-center backdrop-blur-sm">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="text-blue-200 font-normal text-sm">Registration Key Verified:</p>
              </div>
              <p className="text-sm text-blue-400 tracking-wide font-medium">
                Welcome, <span className="text-sm font-black uppercase">{employeeName}!</span> <span className="font-semibold">({position})</span>
              </p>
            </div>
            ...
            <CardContent className="flex flex-col gap-4 p-4 relative z-10">
              <form onSubmit={handleRegister} className="flex flex-col gap-4">
                <div className="space-y-1">
                  <Label htmlFor="username" className="text-gray-200 font-semibold">Username</Label>
                  <Input
                    id="username"
                    type="text"

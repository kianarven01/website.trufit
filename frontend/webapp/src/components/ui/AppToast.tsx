...
const AppToast = ({
  ...
  return (
    ...
    >
      <div
        className={`rounded-md border border-l-4 p-4 shadow-lg backdrop-blur ${style.wrapper}`}
        role="alert"
      >
        <div className="flex items-start gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-sm font-medium leading-tight text-slate-900 dark:text-slate-50">
              {title}
            </p>

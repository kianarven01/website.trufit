    ...
    <main className="min-h-screen">
      ...
      <section className="bg-brand-dark py-24 relative overflow-hidden">
        ...
        <div className="max-w-[1820px] mx-auto px-6 sm:px-10 lg:px-16 text-center relative z-10">
            <h2 className="text-3xl md:text-5xl font-semibold text-white mb-8 uppercase tracking-tight">Ready to see the <br /> <span className="text-brand-red">Trufit difference?</span></h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              >
               ...
               <a 
                href="/contact"
                className="border-2 border-white/20 text-white px-12 py-5 rounded-sm font-semibold hover:bg-white hover:text-brand-dark transition-all uppercase tracking-[0.2em] text-xs"
              >
                Contact Us
              </a>
            </div>

...
export default function ServicesHero() {
  ...
  return (
    <section
      ref={container}
      className="relative h-[60vh] md:h-[70vh] w-full flex items-center justify-center overflow-hidden bg-brand-dark -mt-[112px] md:-mt-[120px]"
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-brand-red font-bold text-sm md:text-base tracking-[0.3em] uppercase">
            Official Partner
          </span>
          <div className="w-8 md:w-12 h-[2px] bg-brand-red" />
        </div>
        ...
        <p className="mt-8 text-gray-300 text-lg md:text-xl max-w-2xl mx-auto font-medium">

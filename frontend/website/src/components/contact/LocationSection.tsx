  ...
  return (
    ...
    >
      <div className="max-w-[1820px] mx-auto px-6 sm:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 lg:gap-x-16 gap-y-8 lg:gap-y-0 items-start">
          
          {/* 1. HEADER - Title & Label (Top on mobile, Right column on desktop) */}
          <div className="lg:col-start-2 lg:row-start-1 order-1 space-y-4">
            ...
            <h2 className="location-reveal text-3xl md:text-5xl font-semibold text-gray-900 leading-tight tracking-tight">
              Visit Our <span className="text-brand-red">Shop</span>
            </h2>
          </div>

          {/* 2. MAP (Between title and details on mobile, Left column on desktop) */}
          <div className="map-animate lg:col-start-1 lg:row-start-1 lg:row-span-2 order-2 mt-4 lg:mt-0">
          ...
          {/* 3. DETAILS CONTENT (Bottom on mobile, Right column on desktop) */}
          <div className="lg:col-start-2 lg:row-start-2 order-3 lg:mt-6 space-y-6">
